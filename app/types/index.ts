...
export interface Location { id: string; name: string; district: string; habitat: string; imageLabel: string; speciesHint: string; bestTime: string; difficulty: "쉬움" | "보통" | "주의"; }
