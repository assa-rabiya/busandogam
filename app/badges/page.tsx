...
export default function BadgesPage() {
  const { user } = useAuth(); const { records } = useDiscoveries(); const achievements = getAchievements(records, user); const earned = achievements.filter((item) => item.earned).length;
