...
const pngDemoIds = new Set<DemoImageId>(["night-crab", "sea-hare"]);
const demoImagePath = (id: DemoImageId) => `/images/species/${id}.${pngDemoIds.has(id) ? "png" : "webp"}`;
