...
export function AppShell({ children }: { children: ReactNode }) { const { user } = useAuth(); return <main className="app-shell"><DesktopNavigation /><section className="app-content"><PageHeader user={user} />{children}</section><BottomNavigation /></main>; }
